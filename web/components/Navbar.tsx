      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a
              href="#waitlist"
              className="cta-button px-8 py-3 rounded-full text-white text-sm font-semibold"
            >
              Join Waitlist
            </a>
          </div>
        ...
        {mobileOpen && (
          <div className="md:hidden glass rounded-2xl mt-2 p-4 animate-fade-in-up">
            ...
            <a
              href="#waitlist"
              onClick={() => setMobileOpen(false)}
              className="block mt-2 cta-button text-center px-8 py-4 rounded-full text-white font-semibold"
            >
              Join Waitlist
            </a>
          </div>
